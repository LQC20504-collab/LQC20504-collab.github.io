...
|Layer|Technology|
|-----|-----|
|Backend|Spring Boot 4.0.7, MyBatis, Spring Security, JWT|
|Database|MySQL 9.5.0 (with stored procedures, triggers, views)|
|AI|Flask (Python 3), binary volume formula|
